...
namespace fsc::builtin
{
    ...
    auto constructVectorFunctions() -> Vector<Function>
    {
        return Vector<Function>{
            ...
            {VectorTemplate,
             ...
             Void,
             {Argument{"value", Template1, ArgumentCategory::IN}},
             RuntimeThrowingMethod},
            {VectorTemplate, "pop_back", "", Void, {}, RuntimeThrowingMethod},
            {VectorTemplate, "sort", "", Void, {}, RuntimeOnlyNoexceptMethod},
            {VectorTemplate,
             "sort",
             "",
             Void,
             {Argument{"reverse", Bool, ArgumentCategory::IN}},
             RuntimeOnlyNoexceptMethod},
            {VectorTemplate,
             "swap",
             "",
             Void,
            ...
            {VectorTemplate,
             ...
             "",
             Template1,
             {Argument{"index", UInt32, ArgumentCategory::IN}},
             RuntimeOnlyNoexceptConstMethod},
            {VectorTemplate,
             "__at__",
             "",
             Template1,
             ...
             RuntimeOnlyNoexceptConstMethod},
            {VectorTemplate, "max", "", Template1, {}, RuntimeThrowingConstMethod},
            {VectorTemplate, "min", "", Template1, {}, RuntimeThrowingConstMethod},
            {VectorTemplate,
             "max",
             "",
             Template1,
    ...
    {
        return Vector<Function>{
            {String, "size", "", UInt64, {}, RuntimeOnlyNoexceptConstMethod},
            {String, "toI32", "", Int32, {}, RuntimeThrowingConstMethod},
            {String, "toI64", "", Int64, {}, RuntimeThrowingConstMethod},
            {String, "toU64", "", UInt64, {}, RuntimeThrowingConstMethod},
            {String, "toF32", "", Float32, {}, RuntimeThrowingConstMethod},
            {String, "toF64", "", Float64, {}, RuntimeThrowingConstMethod},
            {String,
             "__at__",
             "",
             Char,
