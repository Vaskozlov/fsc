...
public:
    ...
    virtual std::any
        visitArgument_passing_type(FscParser::Argument_passing_typeContext *ctx) override
    {
        return visitChildren(ctx);
    }
    ...
    virtual std::any visitFunction_typed_arguments_list(
        FscParser::Function_typed_arguments_listContext *ctx) override
    {
        return visitChildren(ctx);
    }
    ...
    virtual std::any
        visitAuto_variable_definition(FscParser::Auto_variable_definitionContext *ctx) override
    {
        return visitChildren(ctx);
    }
    ...
    virtual std::any
        visitMember_variable_access(FscParser::Member_variable_accessContext *ctx) override
    {
        return visitChildren(ctx);
    }
