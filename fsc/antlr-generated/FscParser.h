...
public:
  enum {
    ...
    DIV = 34, MOD = 35, DOT = 36, EQUALITY = 37, INEQUALITY = 38, LOGICAL_AND = 39, 
    LOGICAL_OR = 40, INT = 41, FLOAT = 42, CHAR = 43, STRING = 44, IDENTIFIER = 45, 
    LAYOUT = 46
  };

  enum {
    RuleProgram = 0, RuleType = 1, RuleStmt = 2, RuleBody = 3, RuleClass = 4, 
    RuleIf_stmt = 5, RuleIf = 6, RuleElif = 7, RuleElse = 8, RuleElif_def = 9, 
    RuleElse_def = 10, RuleFunction = 11, RuleVisibility = 12, RuleFunction_attibutes = 13, 
    RuleVariable_attributes = 14, RuleArgument_passing_type = 15, RuleArgument_definition = 16, 
    RuleParameters = 17, RuleTyped_arguments_list = 18, RuleArgument = 19, 
    RuleFunction_call = 20, RuleFunction_parameter = 21, RuleFunction_typed_arguments_list = 22, 
    RuleFunction_argument = 23, RuleVariable_prefix = 24, RuleAuto_variable_definition = 25, 
    RuleVariable_definition = 26, RuleMember_variable_access = 27, RuleMethod_call = 28, 
    RuleExpr = 29, RuleNew_line = 30, RuleStmt_end = 31
  };
