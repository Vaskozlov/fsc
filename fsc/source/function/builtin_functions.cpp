...
#define BUILTIN_ASSIGN(RESULT, LHS, RHS)                                                           \
    {                                                                                              \
        0, "__copy__", RESULT::typeId,                                                             \
            {Argument{"lhs", LHS::typeId, ArgumentCategory::OUT},                                  \
             Argument{"lhs", RHS::typeId, ArgumentCategory::IN}},                                  \
            CallRequirements::IMPLICIT                                                             \
    }
...
namespace fsc::func
{
    ...
    static const auto InputFunctions = ccl::Vector<ast::Function>{
        {0, "input", String::typeId, {}, CallRequirements::EXPLICIT},
    };
    ...
    FunctionsHolder Functions{AddFunctions,   SubFunctions,        MulFunctions,
                              DivFunctions,   LogicalAndFunctions, LogicalOrFunctions,
                              EqualFunctions, NotEqualFunctions,   AssignFunctions,
                              InputFunctions, OutputFunctions,     FormatFunctions,
                              StringMethods};
}// namespace fsc::func
